            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3 mb-3">Edit Data Provinsi</h1>
                            ...
                            <div class="card-header">
                                <div class="card-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        <?php
                                        $id_provinsi = $_GET['id'];
                                        $getprovinsi = mysqli_query($conn, "SELECT * FROM provinsi WHERE id_provinsi = '$id_provinsi'");
                                        while ($data = mysqli_fetch_array($getprovinsi)) {
                                        ?>

                                        <div class="form-group row">
                                            <label for="editprovinsi" class="col-md-3 col-form-label">Nama Provinsi</label>
                                            <div class="col-md-9">
                                                <input class="form-control" type="text" id="editprovinsi" name="editprovinsi" autocomplete="off" value="<?php echo $data['nama_provinsi']?>" required>
                                            </div>
                                        </div>
                                        <?php } ?>
...
if (isset($_POST['editbtn'])) {
    $editprovinsi = $_POST['editprovinsi'];
    
    $sql = mysqli_query($conn, "UPDATE provinsi SET nama_provinsi ='$editprovinsi' WHERE id_provinsi = '$id_provinsi'");
