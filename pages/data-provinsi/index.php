            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3 mb-3">Data Provinsi</h1>
                                            ...
                                            $getprovinsi = mysqli_query($conn, "select * from provinsi");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <a href="edit?id=<?php echo $data['id_provinsi']; ?>"><button type="button" class="btn btn-success">Edit</button></a>
                                                        <a href="hapus?id=<?php echo $data['id_provinsi']; ?>" onclick="return confirm('Apakah Anda yakin akan menghapus data ini?')"><button type="button" class="btn btn-danger">Hapus</button></a>
                                                        </td>
                                                    </tr>
                                        <?php } ?>
                                    </tbody>
