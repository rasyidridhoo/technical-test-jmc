            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3 mb-3">Tambah Data Kabupaten</h1>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" type="text" id="nama_kabupaten" name="nama_kabupaten" autocomplete="off" required>
                                            </div>
                                        </div>
...
if (isset($_POST['tambahbtn'])) {
    ...
    $sql = mysqli_query($conn, "insert into kabupaten(nama_kabupaten, id_provinsi) VALUES ('$nama_kabupaten', '$tambahprovinsiID')");
