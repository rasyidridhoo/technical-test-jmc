            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3 mb-3">Laporan Data Penduduk</h1>
                        <div class="card mb-4 ">
                            ...
                            <div class="card-header">
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <a href="jumlah_penduduk_provinsi" style="margin-right: 10px;">
                                        <button type="button" class="btn btn-secondary">Print jumlah penduduk per provinsi </button>
                                    </a>
                                    <a href="jumlah_penduduk_kabupaten" style="margin-right: 10px;">
                                        <button type="button" class="btn btn-secondary">Print jumlah penduduk per kabupaten</button>
                                    </a>
                                    <a href="jumlah_penduduk_export">
                                        <button type="button" class="btn btn-secondary">Export Excel daftar penduduk</button>
                                    </a>
                                    </div>
